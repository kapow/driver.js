...
function de(e, o, t, i) {
  ...
  const n = d || t.getBoundingClientRect(), h = i.getBoundingClientRect(), w = W(e, n.x, h.x - n.x, o), r = W(e, n.y, h.y - n.y, o), v = W(e, n.width, h.width - n.width, o), g = W(e, n.height, h.height - n.height, o);
  d = {
    x: w,
    y: r,
    width: v,
    height: g
  }, U(d), b("__activeStagePosition", d);
}
function J(e) {
  if (!e)
    return;
...
function ee(e) {
  const o = window.innerWidth, t = window.innerHeight, i = s("stagePadding") || 0, d = s("stageRadius") || 0, n = e.width + i * 2, h = e.height + i * 2, w = Math.min(d, n / 2, h / 2), r = Math.floor(Math.max(w, 0)), v = e.x - i + r, g = e.y - i, a = n - r * 2, l = h - r * 2;
...
function we(e, o) {
  const i = Date.now(), d = c("__activeStep"), n = c("__activeElement") || e, h = !n || n === e, w = e.id === "driver-dummy-element", r = n.id === "driver-dummy-element", v = s("animate"), g = o.onHighlightStarted || s("onHighlightStarted"), a = (o == null ? void 0 : o.onHighlighted) || s("onHighlighted"), l = (d == null ? void 0 : d.onDeselected) || s("onDeselected"), p = s(), m = c();
  !h && l && l(r ? void 0 : n, d, {
    config: p,
    state: m
  }), g && g(w ? void 0 : e, o, {
  ...
  const u = !h && v;
  let f = !1;
  Ce(), b("previousStep", d), b("previousElement", n), b("activeStep", o), b("activeElement", e);
  const C = () => {
    if (c("__transitionCallback") !== C)
      return;
    const P = Date.now() - i, x = 400 - P <= 400 / 2;
    o.popover && x && !f && u && (Y(e, o), f = !0), s("animate") && P < 400 ? de(P, 400, n, e) : (J(e), a && a(w ? void 0 : e, o, {
      config: s(),
      state: c()
...
function ye(e) {
  ...
  if (!c("isInitialized") || !(e.key === "Tab" || e.keyCode === 9))
    return;
  const i = c("__activeElement"), d = (r = c("popover")) == null ? void 0 : r.wrapper, n = G([
    ...d ? [d] : [],
    ...i ? [i] : []
...
function xe() {
  window.addEventListener("keyup", te, !1), window.addEventListener("keydown", ye, !1), window.addEventListener("resize", R), window.addEventListener("scroll", R);
}
function be() {
  window.removeEventListener("keyup", te), window.removeEventListener("resize", R), window.removeEventListener("scroll", R);
}
function Ce() {
  const e = c("popover");
...
function Y(e, o) {
  ...
  const a = n || s("showButtons"), l = w || s("showProgress") || !1, p = (a == null ? void 0 : a.includes("next")) || (a == null ? void 0 : a.includes("previous")) || l;
  t.closeButton.style.display = a.includes("close") ? "block" : "none", p ? (t.footer.style.display = "flex", t.footer.style.justifyItems = "space-between", t.progress.style.display = l ? "block" : "none", t.nextButton.style.display = a.includes("next") ? "block" : "none", t.previousButton.style.display = a.includes("previous") ? "block" : "none") : t.footer.style.display = "none";
  const m = h || s("disableButtons") || [];
  m != null && m.includes("next") && (t.nextButton.disabled = !0, t.nextButton.classList.add("driver-popover-btn-disabled")), m != null && m.includes("previous") && (t.previousButton.disabled = !0, t.previousButton.classList.add("driver-popover-btn-disabled")), m != null && m.includes("close") && (t.closeButton.disabled = !0, t.closeButton.classList.add("driver-popover-btn-disabled"));
  const u = t.wrapper;
  ...
  u.className = `driver-popover ${C}`.trim(), oe(
    ...
    (S) => {
      var $, B, I;
      const T = S.target, E = (($ = o.popover) == null ? void 0 : $.onNextClick) || s("onNextClick"), A = ((B = o.popover) == null ? void 0 : B.onPrevClick) || s("onPrevClick"), H = ((I = o.popover) == null ? void 0 : I.onCloseClick) || s("onCloseClick");
  ...
  const L = e.classList.contains("driver-dummy-element"), P = G([u, ...L ? [] : [e]]);
...
function ne(e, o) {
  ...
  if (!t)
    return;
  const { align: i = "start", side: d = "left" } = (o == null ? void 0 : o.popover) || {}, n = i, h = e.id === "driver-dummy-element" ? "over" : d, w = s("stagePadding") || 0, r = ie(), v = t.arrow.getBoundingClientRect(), g = e.getBoundingClientRect(), a = g.top - r.height;
  let l = a >= 0;
  ...
  const L = !l && !m && !f && !k;
  let P = h;
  if (h === "top" && l ? k = f = m = !1 : h === "bottom" && m ? k = f = l = !1 : h === "left" && f ? k = l = m = !1 : h === "right" && k && (f = l = m = !1), h === "over") {
...
function ke(e, o, t) {
  ...
  if (!i)
    return;
  const d = t.getBoundingClientRect(), n = ie(), h = i.arrow, w = n.width, r = window.innerWidth, v = d.width, g = d.left, a = n.height, l = window.innerHeight, p = d.top, m = d.height;
  h.className = "driver-popover-arrow";
  let u = o, f = e;
  o === "top" ? (g + v <= 0 ? (u = "right", f = "end") : g + v - w <= 0 && (u = "top", f = "start"), g >= r ? (u = "left", f = "end") : g + w >= r && (u = "top", f = "end")) : o === "bottom" ? (g + v <= 0 ? (u = "right", f = "start") : g + v - w <= 0 && (u = "bottom", f = "start"), g >= r ? (u = "left", f = "start") : g + w >= r && (u = "bottom", f = "end")) : o === "left" ? (p + m <= 0 ? (u = "bottom", f = "end") : p + m - a <= 0 && (u = "left", f = "start"), p >= l ? (u = "top", f = "end") : p + a >= l && (u = "left", f = "end")) : o === "right" && (p + m <= 0 ? (u = "bottom", f = "start") : p + m - a <= 0 && (u = "right", f = "start"), p >= l ? (u = "top", f = "start") : p + a >= l && (u = "right", f = "end")), u ? (h.classList.add(`driver-popover-arrow-side-${u}`), h.classList.add(`driver-popover-arrow-align-${f}`)) : h.classList.add("driver-popover-arrow-none");
}
function Pe() {
  ...
  w.classList.add("driver-popover-navigation-btns"), w.style.display = "flex", w.style.flexDirection = "row-reverse", w.style.flexGrow = "0";
  const r = document.createElement("button");
  r.type = "button", r.classList.add("driver-popover-prev-btn"), r.innerHTML = "&larr; Previous";
  const v = document.createElement("button");
  return v.type = "button", v.classList.add("driver-popover-next-btn"), v.innerHTML = "Next &rarr;", w.appendChild(v), w.appendChild(r), n.appendChild(h), n.appendChild(w), e.appendChild(d), e.appendChild(o), e.appendChild(t), e.appendChild(i), e.appendChild(n), {
    wrapper: e,
    arrow: o,
    title: t,
    description: i,
...
function _e(e = {}) {
  ...
  function h() {
    ...
    if (c("__transitionCallback"))
      return;
    const l = c("activeIndex"), p = c("__activeStep"), m = c("__activeElement");
  ...
  function r() {
    c("isInitialized") || (b("isInitialized", !0), document.body.classList.add("driver-active", s("animate") ? "driver-fade" : "driver-simple"), xe(), N("overlayClick", t), N("escapePress", o), N("arrowLeftPress", h), N("arrowRightPress", w));
  }
  function v(a = 0) {
    var A, H, $, B, I, z, q, V;
    const l = s("steps");
    ...
    const p = l[a], m = l[a + 1], u = l[a - 1], f = ((A = p.popover) == null ? void 0 : A.doneBtnText) || s("doneBtnText") || "Done", C = s("allowClose"), k = typeof ((H = p.popover) == null ? void 0 : H.showProgress) != "undefined" ? ($ = p.popover) == null ? void 0 : $.showProgress : s("showProgress"), P = (((B = p.popover) == null ? void 0 : B.progressText) || s("progressText") || "{{current}} of {{total}}").replace("{{current}}", `${a + 1}`).replace("{{total}}", `${l.length}`), y = ((I = p.popover) == null ? void 0 : I.showButtons) || s("showButtons"), x = [
      "next",
      "previous",
      ...C ? ["close"] : []
  ...
  function g(a = !0) {
    const l = c("__activeElement"), p = c("__activeStep"), m = c("__activeOnDestroyed"), u = s("onDestroyStarted");
    if (a && u) {
    ...
    if (document.body.classList.remove("driver-active", "driver-fade", "driver-simple"), be(), Se(), me(), fe(), le(), K(), l && p) {
